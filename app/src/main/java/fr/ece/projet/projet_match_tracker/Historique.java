...
public class Historique extends AppCompatActivity {
    ...
    public static final String ID_DU_MATCH_SELECTIONNE = "fr.ece.projet.projet_match_tracker.extra.ID_DU_MATCH_SELECTIONNE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MatchDBHelper dbHelper = new MatchDBHelper(this);
        ...
        adapter.setOnItemClickListener(new MatchAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, RecyclerView.ViewHolder viewHolder) {
                Intent intent_details = new Intent(Historique.this, DetailsMatch.class);
