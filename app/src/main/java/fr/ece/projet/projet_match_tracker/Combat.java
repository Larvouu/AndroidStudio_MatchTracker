...
public class Combat extends AppCompatActivity {
    ...
    public static final String TYPE_DE_VICTOIRE = "fr.ece.projet.projet_match_tracker.extra.TYPE_DE_VICTOIRE";

    public static final String NBR_RED_JAB = "fr.ece.projet.projet_match_tracker.extra.NBR_RED_JAB";
    public static final String NBR_RED_UPPERCUT = "fr.ece.projet.projet_match_tracker.extra.NBR_RED_UPPERCUT";
    public static final String NBR_RED_KICK = "fr.ece.projet.projet_match_tracker.extra.NBR_RED_KICK";
    public static final String NBR_RED_TACKLE = "fr.ece.projet.projet_match_tracker.extra.NBR_RED_TACKLE";
    public static final String NBR_RED_IMMO = "fr.ece.projet.projet_match_tracker.extra.NBR_RED_IMMO";

    public static final String NBR_BLUE_JAB = "fr.ece.projet.projet_match_tracker.extra.NBR_BLUE_JAB";
    public static final String NBR_BLUE_UPPERCUT = "fr.ece.projet.projet_match_tracker.extra.NBR_BLUE_UPPERCUT";
    public static final String NBR_BLUE_KICK = "fr.ece.projet.projet_match_tracker.extra.NBR_BLUE_KICK";
    public static final String NBR_BLUE_TACKLE = "fr.ece.projet.projet_match_tracker.extra.NBR_BLUE_TACKLE";
    public static final String NBR_BLUE_IMMO = "fr.ece.projet.projet_match_tracker.extra.NBR_BLUE_IMMO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nom_combattant_un.setText(intent.getStringExtra(Preparation.NOM_COMBATTANT_UN));
        nom_combattant_deux.setText(intent.getStringExtra(Preparation.NOM_COMBATTANT_DEUX));

        nbr_rounds = intent.getStringExtra(Preparation.NOMBRE_DE_ROUNDS);
        categorie_poids = intent.getStringExtra(Preparation.CATEGORIE_POIDS);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        intent_vers_photo.putExtra(Preparation.NOM_COMBATTANT_UN, nom_combattant_un.getText().toString());
        intent_vers_photo.putExtra(Preparation.NOM_COMBATTANT_DEUX, nom_combattant_deux.getText().toString());

        intent_vers_photo.putExtra(Preparation.NOMBRE_DE_ROUNDS, nbr_rounds);
        intent_vers_photo.putExtra(Preparation.CATEGORIE_POIDS, categorie_poids);
