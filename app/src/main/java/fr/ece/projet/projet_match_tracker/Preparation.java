...
public class Preparation extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public static final String NOMBRE_DE_ROUNDS = "fr.ece.projet.projet_match_tracker.extra.NOMBRE_DE_ROUNDS";
    public static final String CATEGORIE_POIDS = "fr.ece.projet.projet_match_tracker.extra.CATEGORIE_POIDS";
